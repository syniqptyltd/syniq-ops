...
import { CheckCircle2, Clock, DollarSign, Handshake, Calendar, FileText, BarChart3, Zap, TrendingUp } from "lucide-react"
...
export function DetailedFeatures() {
  ...
  return (
    <>
      ...
      <section ref={ref1} className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-cyan-50 py-24 sm:py-32">
      ...
      <section ref={ref2} className="relative overflow-hidden bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: Illustration */}
            <motion.div
      ...
      <section ref={ref3} className="relative overflow-hidden bg-gradient-to-br from-cyan-50 to-teal-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: Content */}
            <motion.div
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-white shadow-2xl p-8">
                <div className="h-full flex items-center justify-center">
                  {/* Invoice mockup */}
